...
public class ManageAccountFragment extends Fragment {
    ...
    private void initView(View view)
    {
        ...
        users.add(new User("Sera","Guest","seraavt2"));
        users.add(new User("Neeko","Guest","neekoavt"));
        users.add(new User("Ahri","Guest","ahriavt"));
        users.add(new User("Jinx","Guest","jinxavt"));
        users.add(new User("Lux","Guest","luxavt"));
        users.add(new User("Zoe","Guest","zoeavt"));
