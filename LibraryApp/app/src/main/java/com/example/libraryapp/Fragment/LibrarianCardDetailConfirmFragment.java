...
public class LibrarianCardDetailConfirmFragment extends Fragment {
    ...
    {
        b = getArguments();
        libcard = (Libcard) b.getSerializable("libcard");
    ...
    private void setContentForView()
    {
        ...
        img.setImageResource(getContext().getResources().getIdentifier(libcard.getImage_url(),"drawable",getContext().getPackageName()));
