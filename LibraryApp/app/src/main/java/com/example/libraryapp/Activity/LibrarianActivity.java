...
public class LibrarianActivity extends AppCompatActivity {
    ...
    private void handleSelected()
    {
        ...
        int[][] drawables = {{R.drawable.local_library,R.drawable.send,R.drawable.person,R.drawable.menu_book_selected},
                ...
                {R.drawable.menu_book,R.drawable.statistic,R.drawable.person,R.drawable.send_selected},
                {R.drawable.menu_book,R.drawable.send,R.drawable.statistic,R.drawable.person_selected}};
